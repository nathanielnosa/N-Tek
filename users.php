...
// to fetch the More details information
	...
	$viewmore = mysqli_fetch_assoc($result);
...
//print_r($viewmore);
	...
	if (isset($_POST['addcart'])) {
		...
		$query = "INSERT INTO cart (pro_id, qty, pro_name, pro_price, img, uname)  VALUES ('$pro_id','$qty','$pro_name','$pro_price','$img','$uname')";

		$req = mysqli_query ($conn, $query);

		 $succ = "<p style='color:brown; text-align:center'> Product Added To Cart Successfully ! </p>";
...
<center>
	<h4 style="color:brown">Product</h4>
</center>
				...
				<table class="table">
					<tr >
						...
						<td style="border:none">
							<h3 style="color:brown"><?php echo $viewmore['pro_name']; ?></h3>
							<?php echo "<img src = 'proupload/".$viewmore['img']."' style='width:150px; height:150px'/>"; ?>
							<br/>
							<b><?php echo '#'.number_format($viewmore['pro_price'],2); ?></b>
							
						</td>
						<td style="border:none">
							<h4 style="color:brown"><u>Color: </u><br/><br/><?php echo $viewmore['pro_color']; ?></h4>
							<h4 style="color: brown"><u>Details: </u></h4>
							<ul>

									<?php foreach (explode(',', $viewmore['abt_pro']) as $abt_pro) {?>
										<li style="color:brown"><?php echo $abt_pro; ?></li>
									<?php } ?>
								</ul>
						</td>
					...
					<tr >
						<td style="border:none">
							...
							<div class="form-group">
								<center><h5 style="color:brown">Quantity</h5>
									...
									<br/>
										<input  type="hidden" name="pro_id" value="<?php echo $viewmore['pro_id']; ?>">
										<input  type="hidden" name="pro_name" value="<?php echo $viewmore['pro_name']; ?>">
										<input  type="hidden" name="pro_price" value="<?php echo $viewmore['pro_price']; ?>">
										<input  type="hidden" name="img" value="<?php echo $viewmore['img']; ?>">
										<input  type="hidden" name="uname" value="<?php echo strtoupper($_SESSION['uname']); ?>">
										
											<?php echo $succ; ?>

									<button type="submit" name="addcart" class="form-control" style="background: brown;color:white; width: 300px;"> Add Product To Cart
